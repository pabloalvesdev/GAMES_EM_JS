$(document).ready(function(){
    ...
    const menu_principal_lose = $('#voltar-menu-forca-lose');
    const regras_win = $('#btn-regras-win');
    const regras_lose = $('#btn-regras-lose');
    const cabeca = $('#cabeca');
...
//MODELO A SEGUIR PARA OS OUTROS BOTOES....
    ...
    menu_principal_lose.click(function(){
        jogo_da_memoria.hide();
        jogo_da_velha.hide();
        jogo_da_forca.hide();
        cabeca.hide();
